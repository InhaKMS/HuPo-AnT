import sys
from PyQt5.QtWidgets import QApplication, QMainWindow, QPlainTextEdit, QVBoxLayout, QWidget, QTextEdit
from PyQt5.QtGui import QPainter, QColor, QTextFormat
from PyQt5.QtCore import Qt


class NumberedText(QPlainTextEdit):
    def __init__(self):
        super().__init__()
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("QPlainTextEdit with Line Numbers")
        self.resize(600, 400)
